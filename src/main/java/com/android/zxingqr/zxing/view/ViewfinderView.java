...
package com.android.zxingqr.zxing.view;
...
public final class ViewfinderView extends View {
     ...
     * 线性梯度位置
     */
    public float[] mPositions = new float[]{0f,
            0.5f,
            1f};
    /**
     * 线性梯度各个位置对应的颜色值
     */
    public int[] mScanLineColor = new int[]{0x00FFFFFF,
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            mLinearGradient = new LinearGradient(frame.left + MIDDLE_LINE_PADDING,
                                                 slideTop - MIDDLE_LINE_WIDTH / 2,
                                                 frame.right - MIDDLE_LINE_PADDING,
                                                 slideTop + MIDDLE_LINE_WIDTH / 2,
                                                 mScanLineColor,
